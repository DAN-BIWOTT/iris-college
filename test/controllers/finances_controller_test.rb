...
class FinancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create finance" do
    assert_difference('Finance.count') do
      post finances_url, params: { finance: { dateOfInput: @finance.dateOfInput, name: @finance.name } }
    end
  ...
  test "should update finance" do
    patch finance_url(@finance), params: { finance: { dateOfInput: @finance.dateOfInput, name: @finance.name } }
